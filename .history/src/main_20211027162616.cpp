...
int main(int argc, char** argv){
    ...
    // 相机内参
    Mat cameraMatrix = (Mat_<double>(3, 3) << 2.2115682757919826e+03, 0., 9.5085713142087377e+02, 
                                                0.,2.2115682757919826e+03, 6.0781243579940599e+02, 
                                                0., 0., 1.);
    // 相机畸变
    Mat distCoeff = (Mat_<double>(1, 5) << -2.0937892692144247e-01, 5.2630034682173188e-01,7.0940401122001142e-04, -1.0033227896484038e-03); //-8.2932482995413426e-01
    ...
    if (ifile) {
        ...
        // read all the images inside one folder, and click interested points
