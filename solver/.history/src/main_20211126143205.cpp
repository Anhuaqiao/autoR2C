...
void verification(string path, string path_rad, string result_path, Mat rVec, Mat tVec, Mat cameraMatrix, Mat distCoeff, vector<Point2f>& pic_points, Get_rd rd, Size imageSize){
    string path_config = path + "/config.yaml";
    FileStorage f_(path, FileStorage::READ);
...
int main(int argc, char** argv){
    ...
    cout << rVec << endl;
    cout << tVec << endl;
    verification(path_pic_verify, path_rad, result_path, rVec, tVec, cameraMatrix, distCoeff, pic_points, rd, imageSize);
